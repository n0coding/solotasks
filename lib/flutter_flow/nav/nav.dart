      ...
      errorBuilder: (context, state) => appStateNotifier.showSplashImage
          ? Builder(
              builder: (context) => Container(
                ...
                child: Image.asset(
                  'assets/images/DALLE_2024-04-13_06.53.23_-_Redesign_a_modern_logo_for_an_offline-based_task_management_app_to_emphasize_its_offline_functionality._Incorporate_a_broken_chain_link_or_a_disconnec.webp',
                  fit: BoxFit.cover,
                ),
              ),
            )
